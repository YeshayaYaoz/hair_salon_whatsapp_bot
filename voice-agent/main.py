...
FORMS = {
    "feminine": {
        ...
        "spoken_email": 'כתובת מייל בשיחה עוברת בשני כיוונים, ואל תבלבלי ביניהם. כששומעים אותה: "שטרודל" זה @, "נקודה" זה ., "מקף" זה -, "קו תחתון" זה _, "ג\'ימייל" זה gmail.com, "וואלה" זה walla.co.il, "הוטמייל" זה hotmail.com — ול-send_details תעבירי את הכתובת הכתובה, למשל yeshaya@gmail.com. כשאת חוזרת עליה בקול לאישור: תגידי אותה במילים עבריות ולא בסימנים — "ישעיה, שטרודל, ג\'ימייל נקודה קום". לעולם אל תאמרי "at" ואל תקריאי את הסימן @ עצמו. מספרים שנאמרים במילים המירי לספרות: "אלפיים" זה 2000, "חמישים" זה 50, "עשרים ושמונה" זה 28 — ו"אחת אחת" זה שתי ספרות: 11. אם לא הצלחת להבין — בקשי שיאיית אות-אות, או הציעי לשלוח לוואטסאפ.',
    ...
    "masculine": {
        ...
        "spoken_email": 'כתובת מייל בשיחה עוברת בשני כיוונים, ואל תבלבל ביניהם. כששומעים אותה: "שטרודל" זה @, "נקודה" זה ., "מקף" זה -, "קו תחתון" זה _, "ג\'ימייל" זה gmail.com, "וואלה" זה walla.co.il, "הוטמייל" זה hotmail.com — ול-send_details תעביר את הכתובת הכתובה, למשל yeshaya@gmail.com. כשאתה חוזר עליה בקול לאישור: תגיד אותה במילים עבריות ולא בסימנים — "ישעיה, שטרודל, ג\'ימייל נקודה קום". לעולם אל תאמר "at" ואל תקריא את הסימן @ עצמו. מספרים שנאמרים במילים המר לספרות: "אלפיים" זה 2000, "חמישים" זה 50, "עשרים ושמונה" זה 28 — ו"אחת אחת" זה שתי ספרות: 11. אם לא הצלחת להבין — בקש שיאיית אות-אות, או הצע לשלוח לוואטסאפ.',
