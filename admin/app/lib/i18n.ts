...
const translations = {
  en: {
    nav: {
      ...
      coupons: "Discount codes", whatsapp: "WhatsApp", bot: "Bot settings", payments: "Payments", faq: "FAQ", settings: "Settings", billing: "My subscription", logout: "Log out",
    },
    ...
    maxGuests: "Sleeps", maxGuestsHint: "How many people this unit sleeps. Leave blank if you'd rather confirm it yourself each time — the bot will say so instead of guessing.",
    descriptionOptional: "Description (optional)",
    imageUrlOptional: "Photo link (optional)",
    linkUrlOptional: "More info link (optional)",
    photos: "Photos",
    photosHint: "The bot sends these on WhatsApp when a customer asks to see photos.",
    uploadPhotos: "Upload photos",
    orDragHere: "or drag photos here",
    uploading: "Uploading…",
    photosAfterSave: "Photos can be uploaded once the unit is saved.",
    photosQueued: (n: number) => `${n} photo${n === 1 ? "" : "s"} will be uploaded when you save`,
    orPasteLink: "or paste a link",
    pasteLinkHint: "Use this for a photo already hosted elsewhere. It has to be a direct link to the image file.",
    addPhoto: "Add photo",
    ...
    notifPhone: "Your personal phone (owner) — not the bot's number", notifPhoneHint: "This is YOUR own WhatsApp number, where you'll get alerts about new bookings and customer requests. It is different from the business number the bot answers on. Pick the country on the side — the +972 stands in for the leading 0, so type just the rest, e.g. 501234567 (0501234567 works too).",
    accessibilityContact: "Accessibility contact", accessibilityContactHint: "Published on your booking page's accessibility statement. Israeli law requires every business offering a service online to publish one naming a contact for accessibility matters — and that duty is yours, not ours, because you provide the service. We generate the statement for you; this is the only part we can't fill in. Leave it empty and the statement tells visitors to contact you through your usual channels.",
    ...
    quickRepliesTitle: "Quick reply buttons",
    quickRepliesHint: "Up to 3 tappable answers on the first message, so a customer can start without typing. Tapping one sends that text as their reply. These replace the link button when both are set — WhatsApp allows only one kind per message.",
    quickReplyPlaceholders: ["e.g. Prices", "e.g. Photos", "e.g. Check dates"],
  ...
  he: {
    nav: {
      ...
      coupons: "קודי הנחה", whatsapp: "וואטסאפ", bot: "הגדרות הבוט", payments: "סליקה וחשבוניות", faq: "שאלות נפוצות", settings: "הגדרות", billing: "המנוי שלי", logout: "התנתקות",
    },
    ...
    maxGuests: "מס׳ אורחים", maxGuestsHint: "כמה אנשים היחידה מארחת. אפשר להשאיר ריק אם אתם מעדיפים לאשר התאמה בעצמכם — הבוט יאמר זאת במקום לנחש.",
    descriptionOptional: "תיאור (לא חובה)",
    imageUrlOptional: "קישור לתמונה (לא חובה)",
    linkUrlOptional: "קישור למידע נוסף (לא חובה)",
    photos: "תמונות",
    photosHint: "הבוט שולח את התמונות האלה בוואטסאפ כשלקוח מבקש לראות.",
    uploadPhotos: "העלאת תמונות",
    orDragHere: "או גררו תמונות לכאן",
    uploading: "מעלה…",
    photosAfterSave: "אפשר להעלות תמונות אחרי שמירת היחידה.",
    photosQueued: (n: number) => (n === 1 ? "תמונה אחת תועלה בשמירה" : `${n} תמונות יועלו בשמירה`),
    orPasteLink: "או הדבקת קישור",
    pasteLinkHint: "לשימוש כשהתמונה כבר מאוחסנת במקום אחר. חייב להיות קישור ישיר לקובץ התמונה.",
    ...
    notifPhone: "המספר האישי שלך (בעל/ת העסק) — לא מספר הבוט", notifPhoneHint: "זהו מספר הוואטסאפ האישי שלך, שאליו יגיעו התראות על תורים חדשים ובקשות מלקוחות. זה שונה מהמספר העסקי שהבוט עונה עליו. בוחרים מדינה בצד — ה-972+ מחליף את ה-0 שבתחילת המספר, אז מקלידים רק את ההמשך, לדוג׳ 501234567 (גם 0501234567 יעבוד).",
    ...
    quickRepliesHint: "עד 3 תשובות ללחיצה בהודעה הראשונה, כדי שהלקוח יוכל להתחיל בלי להקליד. לחיצה שולחת את הטקסט שכתוב על הכפתור. הם מחליפים את כפתור הקישור כששניהם מוגדרים — וואטסאפ מאפשרת סוג אחד בלבד בכל הודעה.",
    quickReplyPlaceholders: ["לדוגמה: מחירים", "לדוגמה: תמונות", "לדוגמה: בדיקת תאריכים"],
