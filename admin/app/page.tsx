          ...
          <div className="lp-pricing-inner">
            ...
            <div className="lp-pricing-grid">
              ...
              <div className="lp-plan reveal d3">
                ...
                <div className="lp-plan-divider" />
                <div className="lp-plan-features">
                  {["כל מה שיש ב-Premium","עד 3,000 הודעות יזומות בחודש — פי 3 — למילוי שעות מתות","ליווי הקמה אישי: אנחנו מגדירים הכל אתכם, צעד-צעד","קופצים לראש התור בכל פנייה לתמיכה","התאמות אישיות — הבוט מדבר בדיוק בשפה של העסק שלכם"].map((f) => (
                    <div key={f} className="lp-plan-feat"><span className="check">✓</span>{f}</div>
                  ))}
                </div>
