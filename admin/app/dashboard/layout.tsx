...
const NAV = [
  ...
  { href: "/dashboard/waitlist", label: "Waitlist", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-30 bg-zinc-900 border-b border-zinc-800 flex items-center justify-between px-4 py-3">
        <span className="font-[family-name:var(--font-karantina)] text-lg font-bold text-white tracking-wide">{activeItem?.label ?? "סאלון בוט"}</span>
