...
const DEFAULT_BROADCAST_BODY =
  'היי,\n\nבנינו את תורי — בוט AI שיושב על הוואטסאפ העסקי שלכם ומנהל לבד את קביעת התורים, 24/7, בלי שתצטרכו לענות לכל הודעה בעצמכם.\n\nאנחנו פותחים עכשיו פיילוט למספר מצומצם של עסקים: חודש שלם, בעלות של 80 ש"ח. אתם מקבלים את המערכת המלאה, אנחנו מחברים ומלווים אתכם, ואתם אומרים לנו מה עובד ומה פחות.\n\nרוצים להצטרף? השיבו להודעה הזאת ונשלח פרטים.\n\nתודה,\nצוות תורי';
