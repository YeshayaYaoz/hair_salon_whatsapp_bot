...
const DEFAULT_BROADCAST_SUBJECT = 'הזמנה לפיילוט: בוט AI שקובע לכם תורים — חודש ב-80 ש"ח';
const DEFAULT_BROADCAST_BODY =
  'היי,\n\nאתם מהראשונים שנחשפים לתורי — בוט AI חדש שיושב על הוואטסאפ העסקי שלכם ומנהל לבד את קביעת התורים, 24/7, בלי שתצטרכו לענות לכל הודעה בעצמכם.\n\nלפני ההשקה הרחבה אנחנו פותחים פיילוט סגור למספר מצומצם של עסקים: חודש שלם, בעלות של 80 ש"ח. אתם מקבלים את המערכת המלאה, אנחנו מחברים ומלווים אתכם, ואתם אומרים לנו מה עובד ומה פחות.\n\nרוצים להצטרף? השיבו להודעה הזאת ונשלח פרטים.\n\nתודה,\nצוות תורי';
