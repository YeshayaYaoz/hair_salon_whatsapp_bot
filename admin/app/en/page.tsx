    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* No grayscale(1) and no 0.45 opacity here any more. Both were tuned for the monochrome
           stroke icons this row used to hold, where a muted "logo wall" is a real look — but with
           actual brand marks they defeat the entire mechanism, since recognising the logo at a
           glance IS the persuasion. The opacity was also a contrast failure in its own right:
           #111 at 45% on white lands near 2.8:1, under the 4.5:1 AA needs for the label beside it. */
        .lp-trust-logo { display: flex; align-items: center; gap: 8px; transition: transform 0.2s; }
        .lp-trust-logo:hover { transform: translateY(-1px); }
      ...
      <div className="lp">
        ...
        <div className="lp-trust-bar">
          <div className="lp-trust-bar-inner">
            ...
            {/* Three platforms the owner already has an account with and connects themselves —
                which is what makes a strip like this persuasive rather than decorative. Real brand
                marks rather than the generic stroke icons that were here, because a recognised logo
                is the entire mechanism: a line drawing of a speech bubble carries none of
                WhatsApp's credibility. Facebook is not a courtesy mention — every WhatsApp call
                goes to graph.facebook.com and connecting a number runs through Meta's Embedded
                Signup. Mirrors the Hebrew page. */}
            {[
              {
                text: "Google",
                logo: (
