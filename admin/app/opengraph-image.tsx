...
export const alt = "תורי — קביעת תורים אוטומטית דרך WhatsApp";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

// Branded social-share card. Self-contained (no external assets/fonts) so it always renders.
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Logo mark: rounded chat bubble with a checkmark */}
