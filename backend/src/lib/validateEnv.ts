...
const RECOMMENDED: RequiredVar[] = [
  ...
  { name: "WHATSAPP_EMBEDDED_SIGNUP_REDIRECT_URI", description: "must exactly match a URI registered under Facebook Login > Valid OAuth Redirect URIs (e.g. https://torionline.com/dashboard/whatsapp) — required by Meta's code exchange" },
