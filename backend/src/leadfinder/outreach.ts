...
ההודעה מזמינה את העסק להצטרף לפיילוט של תורי בעלות של 80 ש"ח.
...
- ההצעה היא הזמנה לפיילוט בעלות של 80 ש"ח. ציין את המחיר הזה במפורש — הוא הסיבה המרכזית שההודעה שווה קריאה. אל תוסיף עליו שום פרט מסחרי אחר: לא משך הפיילוט, לא מה יקרה אחריו, לא מחיר עתידי, ולא הנחה או מבצע. אלה דברים שלא סוכמו, והמצאה שלהם היא הבטחה שהעסק יחזיק אותנו בה.
...
export async function generateOutreachDraft(
  ...
  const angleNote =
    angle === "follow_up_1"
      ? 'זו הודעת מעקב (follow-up) — הראשונה כבר נשלחה ולא הייתה תגובה. קצר יותר, לא חוזר על אותו תוכן. ההזמנה לפיילוט ב-80 ש"ח עדיין עומדת, אבל אל תציג אותה כאילו היא חדשה.'
