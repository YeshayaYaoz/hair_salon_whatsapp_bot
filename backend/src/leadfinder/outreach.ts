...
ההודעה מזמינה את העסק להצטרף לפיילוט של תורי: חודש, בעלות של 80 ש"ח. המסגרת היא פיילוט סגור לפני ההשקה הרחבה — העסק מהראשונים שנחשפים למערכת, ומספר המקומות מצומצם.
