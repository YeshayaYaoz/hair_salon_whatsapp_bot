...
שמות הלילות בעברית — השתמש בהם, וגם הבן אותם כשאורח משתמש בהם:
• "ליל שבת" — הלילה שבין שישי לשבת (כניסת שבת).
• "מוצ״ש" או "מוצאי שבת" — הלילה שבין שבת לראשון (צאת שבת). אל תקרא ללילה הזה "יום ראשון"; שמו מוצ״ש.
• חבילת "סופ״ש" של 2 לילות פירושה ליל שבת + מוצ״ש.
