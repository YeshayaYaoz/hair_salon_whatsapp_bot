...
סוף השבוע בישראל הוא יום שישי ויום שבת — לא שבת וראשון. "סופ״ש" פירושו שישי+שבת, ויום ראשון הוא יום עבודה רגיל. חבילת "סופ״ש" של 2 לילות פירושה ליל שישי וליל שבת. זה נכון גם לתאריכים שאינם מופיעים בטבלה למעלה.
